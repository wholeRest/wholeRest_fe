...
export function ComunityPageLatest(){
        ...
        <div className='comunityHomePage'>
          ...
          <div className='comunityHomePage_contents'>
            <div className='comunityHomePage_option'>
              <PopBtn onClick={handlePopBtnClick}><PopBtnImg src="src/image/comunityPage/PopBtnImg.png"/>오늘의 인기글</PopBtn>
              <LatBtn><LatBtnImg src="src/image/comunityPage/LatBtnImg.png"/>최신글</LatBtn>
            </div>
            <Divider /> 
