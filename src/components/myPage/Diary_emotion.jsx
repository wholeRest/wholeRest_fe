...
export function Diary_emotion(props){
   {/* 내 생각엔 이거 체크 박스로 보내야할것 같음. 
    ...
    useEffect(() => {
        console.log("현재 diary값", props.diary);
    }, [props.diary]);
    ...
    return(
        <div id="mypage_Diary_emotion">
            <svg value='1' onClick={checking} 
                className={props.diary === '1' ? "o" : "x"} 
            ...
            <svg value='2'  onClick={checking} 
                className={props.diary === '2' ? "o" : "x"} 
            ...
            <svg value='3' onClick={checking} 
                className={props.diary === '3' ? "o" : "x"} 
            ...
            <svg value='4' onClick={checking} 
                className={props.diary === '4' ? "o" : "x"} 
            ...
            <svg value='5' onClick={checking} 
                className={props.diary === '5' ? "o" : "x"} 
